...
for i in range(1,3):
	#root = "../../features/train/"+str(i)+"/hog/"
	#root = "../../features/train/"+str(i)+"/hof/"
	#root = "../../features/train/"+str(i)+"/trajectory/"
	#root = "../../features/train/"+str(i)+"/mbhx/"
	root = "../../features/train/"+str(i)+"/mbhy/"
