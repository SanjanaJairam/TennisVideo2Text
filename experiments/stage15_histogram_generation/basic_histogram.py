...
kmeans_trajectory = pickle.load(open(pickle_root+"trajectory.pkl",'r'))
kmeans_hog = pickle.load(open(pickle_root+"hog.pkl",'r'))
kmeans_hof = pickle.load(open(pickle_root+"hof.pkl",'r'))
kmeans_mbhx = pickle.load(open(pickle_root+"mbhx.pkl",'r'))
kmeans_mbhy = pickle.load(open(pickle_root+"mbhy.pkl",'r'))
